...
namespace Quanlynhahang
{
    public partial class ucQuanLyNhanVien : UserControl
    {
        ...
        {
            /*
            string query = "exec TimNhanVien @ten";

            dgvNhanVien.DataSource = DataProvider.Instance.ExecuteQuery(query, new object[] { tbHoTen.Text });
            */
        }

        private void btThem_Click(object sender, EventArgs e)
        {
            dgvNhanVien.Rows.Add(i++,tbHoTen.Text,dtpNgaySinh.Text,cbGioiTinh.Text, tbCCCD.Text, tbSDT.Text);
