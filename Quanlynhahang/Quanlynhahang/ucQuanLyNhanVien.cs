...
namespace Quanlynhahang
{
    public partial class ucQuanLyNhanVien : UserControl
    {
        ...
        {
            command = connection.CreateCommand();
            command.CommandText = "insert into NhanVien (CCCD, Ten, NgaySinh, GioiTinh, SDT) values('" + tbCCCD.Text + "',N'" + tbHoTen.Text + "','" + dtpNgaySinh.Text + "',N'" + cbGioiTinh.Text + "','" + tbSDT.Text + "')";
