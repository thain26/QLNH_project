...
namespace Quanlynhahang.DAL
{
    public class MonAnDAL
    {
        ...
        {
            string query = "select MonAn.Ten as N'Tên món ăn', DanhMucMonAn.Ten as N'Danh mục', Gia as N'Đơn giá'  from MonAn, DanhMucMonAn where MaDanhMuc = DanhMucMonAn.Ma order by DanhMucMonAn.Ten";
